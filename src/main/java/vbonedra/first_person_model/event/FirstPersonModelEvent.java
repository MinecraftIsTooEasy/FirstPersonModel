package vbonedra.first_person_model.event;
...
public class FirstPersonModelEvent extends Handlers {
    ...
    public static void register() {
        MITEEvents.MITE_EVENT_BUS.register(new FirstPersonModelEvent());

        Handlers.Initialization.register(new IInitializationListener() {
            @Override
            public void onClientStarted(Minecraft client) {
                FirstPersonModelMod.LOGGER.info("Hello events!");
            }
        });
    }
}
